...
~~~cmd
@cmd
ping 10.52.1.10         PC Network Adapter
ping 10.52.1.2		    CoreTAAS
ping 10.52.1.4		    CoreBABA
ping 10.52.100.8		CUCM
ping 10.52.52.1		EDGE - INSIDE
ping 200.0.0.52		    EDGE - OUTSIDE
...
Windows Server 2022:
  ...
  | Network Adapter 6 | Bridged (Replicate) | 10.52.1.8 /24 |
...
## Web Server
__Configure Web Server (net52.com)__  
1. Internet Information Services Manager
2. Create an `http` mapping for the domain `www.net52.com`
...
__Create Accounts For `net52.com`__
1. Support
2. Admin
3. User
...
~~~
!@cmd SEC-AZURE52
route add 10.0.0.0 mask 255.0.0.0 10.52.1.4 -p
route add 200.0.0.0 mask 255.255.255.0 10.52.1.4 -p
~~~
...
conf t
 ...
 radius server WINRAD
  address ipv4 10.52.1.8 auth-port 1812 acct-port 1813
  key keykeymo
  exit
...
- A Record : utmph.net52.com : 208.8.8.11
